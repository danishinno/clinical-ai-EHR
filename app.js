...
const i18n = {
    ...
    ms: {
        ...
        toggleSidebar: "Senarai Giliran Pesakit",
        profile: " Tetapan Profil",
        history: " Rekod Rawatan Pesakit",
        report: " Laporan Bulanan Klinik",
        manual: " Panduan & Manual Pengguna",
        logout: " Log Keluar",
        bannerPatient: "Pesakit",
        bannerAge: "Umur",
        bannerGender: "Jantina",
        bannerId: "No. K/P",
        queueTitle: "Senarai Giliran Pesakit",
        patientsOnHold: "Pesakit Ditangguhkan",
        noPatientsQueue: "Tiada pesakit dalam giliran.",
        liveDictation: "Pengecaman Suara Langsung",
        startBtn: "Mula Rakam",
        finishBtn: "Selesai",
        dictationPlaceholder: 'Tekan butang "Mula Rakam" dan mulakan percakapan konsultasi...',
        structuredNotes: "Nota Klinikal Berstruktur (SOAP)",
        extractingData: "Sedang menyusun data klinikal...",
        name: "Nama Pesakit",
        age: "Umur",
        gender: "Jantina",
        subjective: "Subjektif (S) - Aduan Pesakit",
        objective: "Objektif (O) - Pemeriksaan Fizikal & Vital",
        assessment: "Penilaian / Diagnosis (A)",
        plan: "Pelan Rawatan & Preskripsi (P)",
        prescriptionsTitle: "Preskripsi & Senarai Ubat",
        addMedication: "+ Tambah Ubat",
        colDrug: "Nama Ubat",
        colDose: "Dos",
        colFreq: "Kekerapan",
        colDur: "Tempoh (Hari)",
        refinerTitle: "Pembetulan / Tambahan Maklumat Klinikal",
        refinerPlaceholder: "Taip sebarang perincian klinikal tambahan atau pembetulan di sini... (contoh: 'Tekanan darah pesakit 130/85 mmHg, tambah Paracetamol 500mg')",
        refineBtn: "Kemaskini Nota SOAP",
        saveConsultation: "Simpan Rekod Rawatan",
        cdsTitle: " Otak Klinikal (CDS)",
        cdsGuidelinesBtn: "Semak Garis Panduan KKM",
        cdsHistoryBtn: "Ringkasan Rekod Lampau",
        cdsTreatmentBtn: "Cadangan Pelan Rawatan",
        cdsPlaceholder: "<p>Tanya sebarang persoalan klinikal berkaitan pesakit atau gunakan Cadangan Pintar.</p>",
        cdsInputPlaceholder: "Tanya soalan klinikal kepada Otak Klinikal...",
        cdsGuidelinesQuery: "Sahkan garis panduan klinikal Kementerian Kesihatan Malaysia (KKM) yang sesuai untuk pesakit ini",
        cdsHistoryQuery: "Ringkaskan sejarah perubatan dan rekod rawatan lampau pesakit ini",
        cdsTreatmentQuery: "Cadangkan pelan rawatan dan dos ubat mengikut amalan perubatan Malaysia"
    }
};
